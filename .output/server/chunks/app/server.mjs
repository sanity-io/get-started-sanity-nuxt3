...
const components = {};
function components_6e3ceafd(nuxtApp) {
...
const vueuseHead_44fab5da = defineNuxtPlugin((nuxtApp) => {
...
const plugin_9b093c64 = defineNuxtPlugin((nuxtApp) => {
...
const router_385abb11 = defineNuxtPlugin((nuxtApp) => {
...
const RootComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2]]);
const _sfc_main$1 = {};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><h1>Hello Nuxt!</h1></div>`);
}
